              ...
              <div className="tp-section-title-box d-flex align-items-center">
                ...
                <h3
                  ...
                  style={{
                    ...
                    margin: 0,
                    letterSpacing: "0.5px",
                    marginRight: "16px", // add space before See All
                  }}
                >
                  EID SALAMI OFFER
                </h3>
              ...
              <div className="tp-section-title-see-all">
                <Link
                  ...
                  style={{
                    ...
                    marginLeft: "8px", // add space after title
                  }}
            ...
            <div className="row">
              <div className="col-12 text-center py-5">
                <div className="text-muted">
                  ...
                  <p>Check back later for amazing EID SALAMI OFFER offers!</p>
                </div>
              </div>
            </div>
          )}
